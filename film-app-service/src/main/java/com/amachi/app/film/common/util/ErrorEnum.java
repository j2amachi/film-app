package com.amachi.app.film.common.util;

import com.amachi.app.film.config.Translator;
...
public enum ErrorEnum {
    ...
    ErrorEnum(String code, String message, HttpStatus status, String description) {
        this.code = code;
